    ...
    export default {
        ...
        methods:{
            proccessConvert(string, index){
                ...
                if(!string || !this.convertIn) return string;

                if(this.convertIn[index] && this.convertIn[index] == 'json'){

                    return this.proccessPopulate(string, index);

                }else 
                
                if(this.convertIn && this.convertIn[index]){
                    let newString = this.convertIn[index].split(':value');
                    return newString.join(string);
                }

                return string;
            },
            proccessPopulate(string, index){
                ...
                try {
                    ...
                    json.map( item => {
                        ...
                        if(jsonIndex < i){
                            ...
                            let newIndex = data[`${index} ${jsonIndex}`];
                ...
                //     if(data[i][index]){
                //            json[i] = JSON.parse(data[i][index]);
                //     }                    
                // }
